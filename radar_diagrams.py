...
GNB5 = pd.DataFrame({
    'group': ['GNB', 'OSB', 'OKNORA-U', 'DESE-C', 'ODESE-C', 'DESE-A', 'ODESE-A'],
...
GNB5s = pd.DataFrame({
    'group': ['GNB', 'OSB', 'OKNORA-U', 'DESIRE-C', 'ODESIRE-C', 'DESIRE-A', 'ODESIRE-A'],
...
CART5 = pd.DataFrame({
    'group': ['CART', 'OSB', 'OKNORA-U', 'DESE-C', 'ODESE-C', 'DESE-A', 'ODESE-A'],
...
KNN5s = pd.DataFrame({
    'group': ['KNN', 'OSB', 'OKNORA-U', 'DESIRE-C', 'ODESIRE-C', 'DESIRE-A', 'ODESIRE-A'],
...
KNN5 = pd.DataFrame({
    'group': ['KNN', 'OSB', 'OKNORA-U', 'DESE-C', 'ODESE-C', 'DESE-A', 'ODESE-A'],
...
CART5s = pd.DataFrame({
    'group': ['CART', 'OSB', 'OKNORA-U', 'DESIRE-C', 'ODESIRE-C', 'DESIRE-A', 'ODESIRE-A'],
